...
Label(text="Book Reccomondation system", font=("Times New Roman", 20)).pack()
tk.Label(window, text="Select Author to recommend: ",font=("Times New Roman", 15)).grid(column=0,row=15, padx=10, pady=25)
n = tk.StringVar()
Author = tk.Combobox(window, width=27, textvariable=n)
...
Button(text='submit', command=values).pack()
window.mainloop()
