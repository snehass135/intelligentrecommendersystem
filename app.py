...
window["bg"] = "cyan"
Label(text="Book Recommender System", font= ("Times New Roman", 20)).grid()
ttk.Label(window, text = "Select Author to recommend: ",font = ("Times New Roman", 10)).grid(column = 0,row = 15, padx = 10, pady = 25)
n = tk.StringVar()
Author = ttk.Combobox(window, width = 27,textvariable = n)
